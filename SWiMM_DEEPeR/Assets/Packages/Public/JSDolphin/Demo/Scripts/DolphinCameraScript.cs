...
public class DolphinCameraScript : MonoBehaviour
{
    public GameObject target;
    public float turnSpeed = .2f;
    public GameObject dolphinCamera;
    ...
    void Update()
    {
        ...
        dolphinCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
    }
