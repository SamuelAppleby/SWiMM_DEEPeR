'''
VANILLA VAE VERSION OF TRAIN_CMVAE.PY
'''
...
import cmvae_models.vae
import cmvae_utils

# define training meta parameters
data_dir = '../logs/vae_data_300k'
output_dir = '../logs/cmvae/300k_run_18_07_22_vanilla'
big_data = True
batch_size = 32
epochs = 30 #15 #50
n_z = 10
...
# create model
if big_data:
    model = cmvae_models.vae.VaeDirect(n_z=n_z, state_dim=3, res=img_res, learning_rate=learning_rate, beta=beta, trainable_model=True, big_data=True)
else:
    model = cmvae_models.vae.VaeDirect(n_z=n_z, state_dim=3, res=img_res, learning_rate=learning_rate, beta=beta, trainable_model=True, big_data=False) 
