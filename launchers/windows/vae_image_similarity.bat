@echo off
cd ..\..\builds\windows
.\SWiMM_DEEPeR.exe modeVAEGen dataDir C:\Users\sambu\Documents\Repositories\CodeBases\SWiMM_DEEPeR\data\image_similarity resolutions 1920 1080 640 360 64 64 numImages 10 seed 1
.\SWiMM_DEEPeR.exe modeVAEGen vaeInterpolate dataDir ..\..\data\interpolation resolutions 64 64 seed 4
